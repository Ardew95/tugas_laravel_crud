...
<body class="container d-flex flex-column h-100">
        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
              <li class="nav-item">
                <a class="nav-link {{request()->routeIs('user.*') ? 'active' : ''}}" aria-current="page" href="{{ route('posts.index')  }}">Home</a>
              </li>
              <li class="nav-item">
                <a class="nav-link {{request()->routeIs('post.*') ? 'active' : ''}}" aria-current="page" href="{{ "#" }}">Post</a>
              </li>
              <li class="nav-item">
  ...
  <footer class="footer mt-auto py-3 bg-dark navbar-dark text-white rounded-top" style="margin-left: 12px; margin-right: 12px;">
    <div class="container text-center">
      <span>Halaman Ini Diperbaharui Oleh Muhammad Fahim Arba Dari Kelompok 2 Amandemy</span>
    </div>
  </footer>
